...
local keys = {
  ...
  ctrl { 'W', act.CloseCurrentTab{ confirm = true } },

  ctrl { "X", act.ActivateCopyMode },
  ctrl { "f", act.TogglePaneZoomState },

  ctrl { "[", act.ActivateTabRelative(-1) },
  ctrl { "]", act.ActivateTabRelative(1) },
  ...
  -- ctrl { 'm', act.Hide },
  -- super { 'm', act.Hide },
  ctrl { "p", act.ActivateCommandPalette },
  ctrl { "r", act.ReloadConfiguration },
  super { "r", act.ReloadConfiguration },
  ctrl { "t", act.SpawnTab("CurrentPaneDomain") },
  super { "t", act.SpawnTab("CurrentPaneDomain") },
